            ...
            {categories.map((category) => (
              <li key={category.name}>
                ...
                >
                  ...
                  <span className="inline-flex items-center justify-center w-8 h-8 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">
                    {category.count}
                  </span>
                </a>
              </li>
